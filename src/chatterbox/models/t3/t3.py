...
# MIT License
import logging
from typing import Union as Union, Optional, List as List
    ...
    def prepare_input_embeds(
        ...
        *,
        ...
        if self.hp.input_pos_emb == "learned":
            text_emb = text_emb + self.text_pos_emb(text_tokens)  # pyright: ignore[reportOptionalCall]
            speech_emb = speech_emb + self.speech_pos_emb(speech_tokens)  # pyright: ignore[reportOptionalCall]
